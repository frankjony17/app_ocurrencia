...
Ext.define('etecsa.controller.pendiente.elemento', {
    ...
    control: {
        ...
        'elemento-grid [text=Adicionar]': {
            click: "show_form"
        },
        'elemento-window': {
            afterrender: "after_render_window"
        },
        'elemento-window [text=Salvar]': {
            click: "is_valid"
        },
        'elemento-grid [text=Eliminar]': {
    ...
    show_form: function () { var me = this;
        Ext.create('etecsa.view.elemento.form', {
            store: me.store
        });
    },
    is_valid: function () {
