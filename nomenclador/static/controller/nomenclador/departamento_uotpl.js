...
Ext.define('etecsa.controller.nomenclador.departamento_uotpl', {
    extend: 'Ext.app.Controller',
    control: {
        'departamento-uotpl-grid': {
            edit: "edit",
            resize: "resize",
            afterrender: "after_render_grid"
        },
        'departamento-uotpl-grid [text=Adicionar]': {
            click: "show_form"
        },
        'departamento-uotpl-win': {
            afterrender: "after_render_window"
        },
        'departamento-uotpl-win [text=Salvar]': {
            click: "is_valid"
        },
        'departamento-uotpl-grid [text=Eliminar]': {
    ...
    show_form: function () { var me = this;
        Ext.create('etecsa.view.departamento_uotpl.form', {
            store: me.store
        });
    },
    is_valid: function () {
    ...
    edit: function (editor, context){ var me = this;
        Ext.Ajax.request({
            url: '/nomenclador/departamento_uotpl/edit',
            params: {
                ...
                email: context.record.get('email')
            },
    ...
    remove: function () { var me = this, ids = [];
        ...
        Ext.Ajax.request({
            url: '/nomenclador/departamento_uotpl/remove',
