...
Ext.define('etecsa.controller.nomenclador.personal_mincom_tpl', {
    extend: 'Ext.app.Controller',
    control: {
        'personal-mincom-tpl-grid': {
            edit: "edit",
            resize: "resize",
            afterrender: "after_render_grid"
        },
        'personal-mincom-tpl-grid [text=Adicionar]': {
            click: "show_form"
        },
        'personal-mincom-tpl-win': {
            afterrender: "after_render_window"
        },
        'personal-mincom-tpl-win [text=Salvar]': {
            click: "is_valid"
        },
        'personal-mincom-tpl-grid [text=Eliminar]': {
    ...
    show_form: function () { var me = this;
        Ext.create('etecsa.view.personal_mincom_tpl.form', {
            store: me.store
        });
    },
    is_valid: function () {
    ...
    edit: function (editor, context){ var me = this;
        Ext.Ajax.request({
            url: '/nomenclador/personal_mincom_tpl/edit',
            params: {
                id: context.record.get('id'),
                nombre: context.record.get('nombre'),
                cargo: context.record.get('cargo')
            },
    ...
    remove: function () { var me = this, ids = [];
        ...
        Ext.Ajax.request({
            url: '/nomenclador/personal_mincom_tpl/remove',
