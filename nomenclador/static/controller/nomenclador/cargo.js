...
Ext.define('etecsa.controller.nomenclador.cargo', {
    ...
    control: {
        ...
        'cargo-grid [text=Adicionar]': {
            click: "show_form"
        },
        'cargo-win': {
            afterrender: "after_render_window"
        },
        'cargo-win [text=Salvar]': {
            click: "is_valid"
        },
        'cargo-grid [text=Eliminar]': {
    ...
    show_form: function () { var me = this;
        Ext.create('etecsa.view.cargo.form', {
            store: me.store
        });
    },
    is_valid: function () {
