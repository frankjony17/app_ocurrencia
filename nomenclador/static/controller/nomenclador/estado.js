...
Ext.define('etecsa.controller.nomenclador.estado', {
    ...
    control: {
        ...
        'estado-grid [text=Adicionar]': {
            click: "show_form"
        },
        'estado-win': {
            afterrender: "after_render_window"
        },
        'estado-win [text=Salvar]': {
            click: "is_valid"
        },
        'estado-grid [text=Eliminar]': {
    ...
    show_form: function () { var me = this;
        Ext.create('etecsa.view.estado.form', {
            store: me.store
        });
    },
    is_valid: function () {
